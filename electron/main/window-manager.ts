...
export function showOverlay(): void {
  console.log('[window-manager] showOverlay called, overlayWindow exists:', !!overlayWindow)
  ...
  overlayWindow?.show()
  console.log('[window-manager] Overlay window visible:', overlayWindow?.isVisible())
}
